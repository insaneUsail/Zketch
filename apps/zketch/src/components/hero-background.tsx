...
export default function HeroBackground() {
  ...
  return (
    <>
      {/* Gradient overlay */}
      <div className="absolute inset-0 bg-gradient-to-br from-brand-300/30 to-accent-300/30 dark:from-brand-900/30 dark:to-accent-900/30 z-0" />
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
        {/* Top right blob */}
        <motion.div
          className="absolute -top-20 -right-20 w-64 h-64 bg-brand-400/10 dark:bg-brand-600/10 rounded-full blur-3xl"
          animate={{
            scale: [1, 1.2, 1],
            rotate: [0, 10, 0],
            opacity: [0.5, 0.7, 0.5],
        ...
        {/* Bottom left blob */}
        <motion.div
          className="absolute -bottom-32 -left-32 w-96 h-96 bg-accent-400/10 dark:bg-accent-600/10 rounded-full blur-3xl"
          animate={{
            scale: [1, 1.3, 1],
            rotate: [0, -10, 0],
            opacity: [0.5, 0.7, 0.5],
        ...
        {/* Center blob */}
        <motion.div
          className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-brand-400/5 dark:bg-brand-600/5 rounded-full blur-3xl"
          animate={{
            scale: [1, 1.4, 1],
            opacity: [0.3, 0.5, 0.3],
          }}
