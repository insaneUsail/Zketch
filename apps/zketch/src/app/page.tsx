...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background overflow-hidden">
        ...
        <nav className="container mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
            ...
            >
              ...
              >
                <motion.span
                  className="absolute -inset-1 rounded-lg bg-gradient-to-r from-brand-400 to-accent-500 opacity-70 blur-lg"
                  animate={{
                    opacity: [0.5, 0.8, 0.5],
                    rotate: [0, 5, 0],
                  }}
                ...
                {navItems.map((item, index) => (
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <motion.span
                          className="absolute bottom-0 left-0 w-full h-0.5 bg-gradient-to-r from-brand-400 to-accent-500 rounded-full"
                          initial={{ scaleX: 0, opacity: 0 }}
                          whileHover={{ scaleX: 1, opacity: 1 }}
                          transition={{ duration: 0.3 }}
                        />
                        <motion.span
                          className="absolute inset-0 bg-gradient-to-r from-brand-400/10 to-accent-500/10 rounded-md opacity-0"
              ...
              >
                <Link href="/auth/sign-in">
                  ...
                  >
                    <Button
                      variant="ghost"
                      className="text-black dark:text-white hover:text-brand-400 relative overflow-hidden group"
                    >
                      <motion.span
                        className="absolute inset-0 bg-gradient-to-r from-brand-400/20 to-accent-500/20 rounded-md opacity-0"
                        whileHover={{ opacity: 1 }}
                        transition={{ duration: 0.3 }}
                      />
                ...
                <Link href="/auth/sign-up">
                  ...
                  >
                    <motion.span
                      className="absolute -inset-0.5 bg-gradient-to-r from-brand-400 to-accent-500 rounded-md opacity-75 blur-sm"
                      animate={{
                        opacity: [0.5, 0.8, 0.5],
                      }}
                      transition={{
                    ...
                    />
                    <Button className="relative bg-gradient-to-r from-brand-500 to-accent-600 hover:from-brand-600 hover:to-accent-700 text-white border-0">
                      Sign Up
                    </Button>
                  </motion.div>
                </Link>
              ...
              <div className="container mx-auto px-6 py-4 flex flex-col space-y-4">
                {navItems.map((item, index) => (
                  ...
                  >
                    ...
                    >
                      <Button
                        variant="ghost"
                        className="w-full justify-start text-black dark:text-white hover:text-brand-400"
                      >
                        {item.name}
                      </Button>
                    </ScrollLink>
                ...
                >
                  <Link
                    ...
                    onClick={() => setIsMenuOpen(false)}
                  >
                    <Button className="w-full bg-gradient-to-r from-brand-500 to-accent-600 hover:from-brand-600 hover:to-accent-700 text-white">
                      Sign Up
                    </Button>
                  </Link>
                </motion.div>
      ...
      >
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            >
              <motion.div
                className="px-4 py-1 rounded-full bg-gradient-to-r from-brand-500/20 to-accent-600/20 text-brand-600 dark:text-brand-400 text-sm font-medium border border-brand-200 dark:border-brand-800"
                animate={{
                  boxShadow: [
            ...
            >
              ...
              <motion.span
                className="inline-block bg-clip-text text-transparent bg-gradient-to-r from-brand-500 to-accent-600 dark:from-brand-400 dark:to-accent-500"
                animate={{
              ...
              {/* Decorative elements */}
              <motion.div
                className="absolute -top-10 -right-10 w-20 h-20 text-brand-500 opacity-20 hidden md:block"
                animate={{
                  rotate: [0, 360],
                  scale: [1, 1.1, 1],
                }}
              ...
              <motion.div
                className="absolute -bottom-16 -left-10 w-16 h-16 text-accent-500 opacity-20 hidden md:block"
                animate={{
                  rotate: [0, -360],
                  scale: [1, 1.2, 1],
                }}
            ...
            >
              <Link href="/dashboard">
                ...
                >
                  <Button
                    size="lg"
                    className="relative overflow-hidden bg-gradient-to-r from-brand-500 to-accent-600 hover:from-brand-600 hover:to-accent-700 text-white border-0 rounded-lg"
                  >
                    <motion.span
              ...
              <ScrollLink to="video" smooth={true} duration={400}>
                ...
                >
                  ...
                  >
                    <motion.span
                      className="absolute inset-0 bg-gradient-to-r from-brand-400/10 to-accent-500/10"
                      initial={{ y: "-100%" }}
                      whileHover={{ y: "100%" }}
        ...
        >
          ...
          >
            <motion.div
              className="w-1.5 h-3 bg-gradient-to-b from-brand-500 to-accent-600 rounded-full absolute top-2"
              animate={{
                y: [0, 24, 0],
              }}
              transition={{
            ...
            />
            <motion.div
              className="absolute inset-0 bg-gradient-to-b from-brand-500/20 to-accent-600/20 opacity-0"
              whileHover={{ opacity: 1 }}
              transition={{ duration: 0.2 }}
            />
          </motion.div>
      ...
      >
        <motion.div
          className="absolute inset-0 bg-gradient-to-b from-transparent to-brand-50 dark:to-brand-950 opacity-50 z-0"
          animate={{
            opacity: [0.3, 0.5, 0.3],
          }}
        ...
        >
          ...
          >
            <motion.h2
              className="text-3xl md:text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-brand-500 to-accent-600 dark:from-brand-400 dark:to-accent-500"
              animate={{
                backgroundPosition: ["0% center", "100% center", "0% center"],
              }}
              transition={{ duration: 8, repeat: Number.POSITIVE_INFINITY }}
            >
              See zketch in Action
            </motion.h2>
            <motion.p
      ...
      >
        <motion.div
          className="absolute inset-0 bg-gradient-to-br from-brand-50 to-brand-50 dark:from-brand-950 dark:to-brand-950 opacity-50"
          animate={{
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            {features.map((feature, index) => (
              <motion.div
                key={index}
                className="group relative p-6 bg-white dark:bg-gray-800 rounded-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-700 hover:border-brand-300 dark:hover:border-brand-700"
              ...
              >
                <motion.div
                  className="w-12 h-12 rounded-lg bg-brand-100 dark:bg-brand-900 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300"
                ...
                {/* Decorative element */}
                <motion.div
                  className="absolute bottom-0 left-0 h-1 bg-gradient-to-r from-brand-400 to-accent-500 rounded-b-lg"
                  initial={{ width: "0%" }}
      ...
      <motion.section
        id="about"
        ref={ctaRef}
        className="bg-gradient-to-r from-brand-500 to-brand-600 dark:from-brand-700 dark:to-brand-800 relative overflow-hidden"
        initial={{ opacity: 0 }}
        whileInView={{ opacity: 1 }}
        transition={{ duration: 0.8 }}
        viewport={{ once: true, amount: 0.3 }}
        ...
        >
          <div className="flex flex-col md:flex-row items-center justify-between">
            ...
            >
              ...
              <motion.p
                className="text-lg text-brand-100 dark:text-brand-200"
                initial={{ opacity: 0 }}
                whileInView={{ opacity: 1 }}
                transition={{ duration: 0.5, delay: 0.2 }}
                viewport={{ once: true }}
...
const features = [
  {
    ...
    icon: <Users2 className="w-6 h-6 text-brand-600 dark:text-brand-400" />,
  },
  {
    title: "Intuitive Drawing Tools",
    description:
      "Easy-to-use tools for creating professional diagrams and sketches.",
    icon: <Pen className="w-6 h-6 text-brand-600 dark:text-brand-400" />,
  },
  {
    title: "Easy Sharing",
    description:
      "Share your work with a simple link or export in multiple formats.",
    icon: <Share2 className="w-6 h-6 text-brand-600 dark:text-brand-400" />,
  },
  {
  ...
  },
  {
    ...
    icon: <Cloud className="w-6 h-6 text-brand-600 dark:text-brand-400" />,
  },
  {
